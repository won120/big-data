...
<%
	member.setIdx(Integer.parseInt(String.valueOf(session.getAttribute("useridx"))));	// String으로 바꿨다가 집어넣음
...
<body>
    ...
    <form name="regform" id="regform" method="post" action="info_ok.jsp" onsubmit="return sendit()">
        ...
        <p>주민등록번호 : <input type="text" name="ssn1" id="ssn1" maxlength="6" value="<%=member.getSsn1()%>"> - <input type="text" name="ssn2" id="ssn2" maxlength="7" value="<%=member.getSsn2()%>"> <input type="button" id="ssnBtn" value="주민등록번호 검증"></p>
